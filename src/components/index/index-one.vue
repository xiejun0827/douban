        ...
        <div class="swiper-slide" v-for="(item,ind) in arr.subjects" @click="send(item.id)">
          ...
          <div class="ooo">
            ...
            <div v-if="item.rating.average>0">
              <img v-for="ite in ooo" :src="[item.rating.average/2-ite>
              1?src.img1:item.rating.average/2-ite<1&&item.rating.average/2-ite>0?src.img2:src.img3]">
